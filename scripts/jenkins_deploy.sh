...
then
    ...
    xmlstarlet ed -u '//hudson.plugins.postbuildtask.PostbuildTask/tasks/hudson.plugins.postbuildtask.TaskProperties/script' -v wget https://raw.githubusercontent.com/sysgain/MSOSS/staging/scripts/mongodbvhdurl.sh&#xd;chmod +x mongodbvhdurl.sh&#xd;sh mongodbvhdurl.sh $2 $3 $4 $10; $srcdir/MongoDBPackerjob.xml | >> $srcdir/MongoDBPackerjob-newconfig.xml
fi
